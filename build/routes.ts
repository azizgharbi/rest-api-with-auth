...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { UserController } from "./../src/app/users/controller";
import { expressAuthentication } from "./../src/middlewares/auth/index";
...
export function RegisterRoutes(app: Router) {
	...
	app.get(
		...
		...fetchMiddlewares<RequestHandler>(UserController),
		...fetchMiddlewares<RequestHandler>(UserController.prototype.secret),

		function UserController_secret(request: any, response: any, next: any) {
			const args = {};
			...
			try {
				...
				const promise = controller.secret.apply(
					controller,
					validatedArgs as any,
				);
				promiseHandler(controller, promise, response, undefined, next);
